...
namespace Microsoft.Azure.Management.HDInsight.Models
{
    ...
    /// ClusterFlavors, NodeTypes and ClusterVersionsThe dimensions of this set
    /// are Regions, ClusterFlavors, NodeTypes and ClusterVersions. The
    /// constraint should be defined based on the following: FilterMode
    /// (Exclude vs Include), VMSizes (the vm sizes in affect of
    /// exlucsion/inclusion) and the ordering of the Filters. Later filters
    ...
    public partial class VmSizeCompatibilityFilterV2
    {
        ...
        /// black or whitelist the vm sizes in a particular set.</param>
        ...
        /// <param name="vmSizes">The list of virtual machine sizes to
        ...
        /// <summary>
        /// Gets or sets the filtering mode. Effectively this can black or
        /// whitelist the vm sizes in a particular set.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the list of virtual machine sizes to include/exclude.
        /// </summary>
