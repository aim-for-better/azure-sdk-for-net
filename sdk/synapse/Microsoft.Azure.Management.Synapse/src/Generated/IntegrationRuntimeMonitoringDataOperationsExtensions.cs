...
namespace Microsoft.Azure.Management.Synapse
{
    ...
    public static partial class IntegrationRuntimeMonitoringDataOperationsExtensions
    {
            ...
            /// </param>
            public static object Get(this IIntegrationRuntimeMonitoringDataOperations operations, string resourceGroupName, string workspaceName, string integrationRuntimeName)
            {
            ...
            /// </param>
            public static async Task<object> GetAsync(this IIntegrationRuntimeMonitoringDataOperations operations, string resourceGroupName, string workspaceName, string integrationRuntimeName, CancellationToken cancellationToken = default(CancellationToken))
            {
