...
namespace Microsoft.Azure.Management.Synapse
{
    ...
    /// <summary>
    /// IntegrationRuntimeOperationStatusOperations operations.
    /// </summary>
    internal partial class IntegrationRuntimeOperationStatusOperations : IServiceOperations<SynapseManagementClient>, IIntegrationRuntimeOperationStatusOperations
    {
        /// <summary>
        /// Initializes a new instance of the IntegrationRuntimeOperationStatusOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal IntegrationRuntimeOperationStatusOperations(SynapseManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </summary>
        /// <remarks>
        /// Get the status of an operation runtime
        /// </remarks>
        ...
        /// </return>
        public async Task<AzureOperationResponse<object>> ListWithHttpMessagesAsync(string resourceGroupName, string workspaceName, string integrationRuntimeName, string actionName, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/integrationRuntimes/{integrationRuntimeName}/{actionName}/operationStatuses/{operationId}").ToString();
