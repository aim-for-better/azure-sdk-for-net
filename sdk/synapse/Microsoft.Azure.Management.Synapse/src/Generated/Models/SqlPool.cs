...
namespace Microsoft.Azure.Management.Synapse.Models
{
    ...
    public partial class SqlPool : IResource
    {
        /// <summary>
        ...
        public SqlPool(Sku sku = default(Sku), long? maxSizeBytes = default(long?), string collation = default(string), string sourceDatabaseId = default(string), string recoverableDatabaseId = default(string), string provisioningState = default(string), string status = default(string), System.DateTime? restorePointInTime = default(System.DateTime?), string createMode = default(string), System.DateTime? creationDate = default(System.DateTime?))
        {
            Sku = sku;
