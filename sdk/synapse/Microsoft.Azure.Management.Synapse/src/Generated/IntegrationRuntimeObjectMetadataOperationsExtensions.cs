...
namespace Microsoft.Azure.Management.Synapse
{
    ...
    public static partial class IntegrationRuntimeObjectMetadataOperationsExtensions
    {
            ...
            /// </param>
            public static object Get(this IIntegrationRuntimeObjectMetadataOperations operations, string resourceGroupName, string workspaceName, string integrationRuntimeName)
            {
            ...
            /// </param>
            public static async Task<object> GetAsync(this IIntegrationRuntimeObjectMetadataOperations operations, string resourceGroupName, string workspaceName, string integrationRuntimeName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Integration runtime name
            /// </param>
            public static object Refresh(this IIntegrationRuntimeObjectMetadataOperations operations, string resourceGroupName, string workspaceName, string integrationRuntimeName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> RefreshAsync(this IIntegrationRuntimeObjectMetadataOperations operations, string resourceGroupName, string workspaceName, string integrationRuntimeName, CancellationToken cancellationToken = default(CancellationToken))
            {
