...
namespace Microsoft.Azure.Management.Synapse
{
    ...
    public static partial class SqlPoolsOperationsExtensions
    {
            ...
            /// SQL pool name
            /// </param>
            public static SqlPool Update(this ISqlPoolsOperations operations, string resourceGroupName, string workspaceName, string sqlPoolName)
            {
                return operations.UpdateAsync(resourceGroupName, workspaceName, sqlPoolName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SqlPool> UpdateAsync(this ISqlPoolsOperations operations, string resourceGroupName, string workspaceName, string sqlPoolName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateWithHttpMessagesAsync(resourceGroupName, workspaceName, sqlPoolName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
